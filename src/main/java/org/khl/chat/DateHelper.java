...
public class DateHelper {
	...
	private static final DateTimeFormatter QUEUE_DATE_TIME_FORMATTER = DateTimeFormatter.ofPattern("yyyy-MM-dd'T'HH:mm:ss");
	
	private static final ZoneOffset defaultClientZoneOffset = ZoneOffset.of("+03:00");
	
	private static final DateTimeFormatter DEFAULT_OFFSET_DATE_TIME_FORMATTER = DateTimeFormatter.ofPattern("dd-MM-yyyy'T'HH:mm:ssXXX");
